...
func NewSssRefundData2018Mgr(db db.Repo) *SssRefundData2018Mgr {
	...
	return &SssRefundData2018Mgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_sss_refund_data_2018"), wdb: db.GetDbW().Table("es_sss_refund_data_2018"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
