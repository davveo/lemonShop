...
func NewGroupbuyGoodsMgr(db db.Repo) *GroupbuyGoodsMgr {
	...
	return &GroupbuyGoodsMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_groupbuy_goods"), wdb: db.GetDbW().Table("es_groupbuy_goods"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
