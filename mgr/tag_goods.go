...
func NewTagGoodsMgr(db db.Repo) *TagGoodsMgr {
	...
	return &TagGoodsMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_tag_goods"), wdb: db.GetDbW().Table("es_tag_goods"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
