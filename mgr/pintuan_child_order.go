...
func NewPintuanChildOrderMgr(db db.Repo) *PintuanChildOrderMgr {
	...
	return &PintuanChildOrderMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_pintuan_child_order"), wdb: db.GetDbW().Table("es_pintuan_child_order"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
