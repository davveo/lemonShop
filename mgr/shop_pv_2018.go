...
func NewSssShopPv2018Mgr(db db.Repo) *SssShopPv2018Mgr {
	...
	return &SssShopPv2018Mgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_sss_shop_pv_2018"), wdb: db.GetDbW().Table("es_sss_shop_pv_2018"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
