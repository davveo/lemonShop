...
func NewMemberCollectionShopMgr(db db.Repo) *MemberCollectionShopMgr {
	...
	return &MemberCollectionShopMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_member_collection_shop"), wdb: db.GetDbW().Table("es_member_collection_shop"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
