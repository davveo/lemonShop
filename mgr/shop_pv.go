...
func NewSssShopPvMgr(db db.Repo) *SssShopPvMgr {
	...
	return &SssShopPvMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_sss_shop_pv"), wdb: db.GetDbW().Table("es_sss_shop_pv"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
