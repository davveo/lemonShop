...
func NewHalfPriceMgr(db db.Repo) *HalfPriceMgr {
	...
	return &HalfPriceMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_half_price"), wdb: db.GetDbW().Table("es_half_price"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
