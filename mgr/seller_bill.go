...
func NewSellerBillMgr(db db.Repo) *SellerBillMgr {
	...
	return &SellerBillMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_seller_bill"), wdb: db.GetDbW().Table("es_seller_bill"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
