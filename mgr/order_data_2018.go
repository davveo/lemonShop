...
func NewSssOrderData2018Mgr(db db.Repo) *SssOrderData2018Mgr {
	...
	return &SssOrderData2018Mgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_sss_order_data_2018"), wdb: db.GetDbW().Table("es_sss_order_data_2018"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
