...
func NewSssShopPv2017Mgr(db db.Repo) *SssShopPv2017Mgr {
	...
	return &SssShopPv2017Mgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_sss_shop_pv_2017"), wdb: db.GetDbW().Table("es_sss_shop_pv_2017"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
