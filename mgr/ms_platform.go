...
func NewSmsPlatformMgr(db db.Repo) *SmsPlatformMgr {
	...
	return &SmsPlatformMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_sms_platform"), wdb: db.GetDbW().Table("es_sms_platform"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
