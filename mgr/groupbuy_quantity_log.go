...
func NewGroupbuyQuantityLogMgr(db db.Repo) *GroupbuyQuantityLogMgr {
	...
	return &GroupbuyQuantityLogMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_groupbuy_quantity_log"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
