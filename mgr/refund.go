...
func NewRefundMgr(db db.Repo) *RefundMgr {
	...
	return &RefundMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_refund"), wdb: db.GetDbW().Table("es_refund"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
