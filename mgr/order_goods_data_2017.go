...
func NewSssOrderGoodsData2017Mgr(db db.Repo) *SssOrderGoodsData2017Mgr {
	...
	return &SssOrderGoodsData2017Mgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_sss_order_goods_data_2017"), wdb: db.GetDbW().Table("es_sss_order_goods_data_2017"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
