...
func NewUploaderMgr(db db.Repo) *UploaderMgr {
	...
	return &UploaderMgr{_BaseMgr: &_BaseMgr{rdb: db.GetDbR().Table("es_uploader"), wdb: db.GetDbW().Table("es_uploader"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}
